...
def args():
    ...
    train_arg_parser.add_argument("--epochs_contrastive", type=int, default=150,
...
def train_rep(model_name, epochs):
    ...
    for epoch in range(epochs):
        ...
        if epoch > 50 and (epoch+1) % 25 == 0:
            torch.save(netE.state_dict(), './rep_models/ISIC_{}_{}_netE_{}.pth'.format(args().train_mode,model_name,epoch+1))
